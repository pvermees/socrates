...
eruption duration dataset to a normal distribution:

\noindent\begin{minipage}[t][][b]{.55\textwidth}
  \includegraphics[]{../figures/qqexplainer.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.45\textwidth}
  \captionof{figure}{Construction of a Q-Q plot. a) is the ECDF of the
    Old Faithful eruption durations, rotated 90 degrees
    counterclockwise; b) is the actual Q-Q plot comparing the eruption
    durations with a normal distribution; c) is the CDF of a standard
    normal distribution.  If the two distributions being compared are
  ...
  \label{fig:qqexplainer}
\end{minipage}

We can use the Q-Q plot to illustrate the effect of the Central Limit
Theorem (Figure~\ref{fig:CLTfaithful1}):

\noindent\begin{minipage}[t][][b]{.6\textwidth}
  \includegraphics[]{../figures/qqfaithful.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.4\textwidth}
  \captionof{figure}{Q-Q plots of a) the original Old Faithful
    eruption durations; and 500 sums of b) $n = 2$; c) $n = 10$; and
    d) $n = 10$ randomly selected eruption durations. Increasing $n$
    brings the Q-Q plot ever closer to the 1:1 line, visually
    confirming the emergence of a normal distribution.  The sample
    distribution for $n = 10$ only deviates from the theoretical
    distribution at the most extreme quantiles. This indicates that
    the sample distribution has heavier tails than the normal
    distribution. This phenomenon will be discussed further in the
    next section. Increasing $n$ further would remove this effect near
    the tails and bring the sample distribution even closer to the
    normal distribution.\medskip}
  \label{fig:qqfaithful}
\end{minipage}
...
\noindent\includegraphics[]{../figures/cherrypicking.pdf}\medskip
\begingroup
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
  \includegraphics[]{../figures/KS.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.6\textwidth}
  \includegraphics[]{../figures/KSdens.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.4\textwidth}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
  \includegraphics[]{../figures/KSnorm.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.65\textwidth}
