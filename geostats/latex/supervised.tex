...
\noindent\includegraphics[]{../figures/QDA.pdf}
...
\noindent\includegraphics[]{../figures/LDA.pdf}
...
\noindent\begin{minipage}[t][][b]{.55\textwidth}
  \noindent\includegraphics[]{../figures/PCAvsLDA.pdf}\\
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
  \includegraphics[]{../figures/LDAiris.pdf}\\
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
\includegraphics[]{../figures/LDAnewiris.pdf}\\
\end{minipage}
\begin{minipage}[t][][t]{.65\textwidth}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
\includegraphics[]{../figures/CARTdata.pdf}\\
\end{minipage}
\begin{minipage}[t][][t]{.65\textwidth}
...
\noindent\includegraphics[]{../figures/Qtries.pdf}
...
\noindent\begin{minipage}[t][][b]{.7\textwidth}
\includegraphics[]{../figures/overfittedCARTscatter.pdf}\\
\end{minipage}
\begin{minipage}[t][][t]{.3\textwidth}
...
\includegraphics[]{../figures/cvCART.pdf}\\
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.7\textwidth}
\includegraphics[]{../figures/optimalCART.pdf}\\
\end{minipage}
\begin{minipage}[t][][t]{.3\textwidth}
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
\includegraphics[]{../figures/irisCART.pdf}\\
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
