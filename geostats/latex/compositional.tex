...
\includegraphics[]{../figures/ACNK.pdf}\medskip
\end{minipage}
...
\begin{equation}
  x = \frac{e^u}{e^u + e^v + 1} \mbox{,~}
  y = \frac{e^v}{e^u + e^v + 1} \mbox{~and~}
  z = \frac{1}{e^u + e^v + 1}
...
\begin{equation}
  u = \ln\!\left[\frac{x}{g(x,y,z)}\right] \mbox{,~}
  v = \ln\!\left[\frac{y}{g(x,y,z)}\right] \mbox{~and~}
  w = \ln\!\left[\frac{z}{g(x,y,z)}\right]
  \label{eq:clr}
\end{equation}

\noindent where $g(x,y,z)$ is the geometric mean of the composition:
\[
g(x,y,z) = \exp\!\left[\frac{\ln[x]+\ln[y]+\ln[z]}{3}\right]
\]

The inverse clr-transformation is defined as follows:
\begin{equation}
    x = \frac{e^u}{e^u+e^v+e^w} \mbox{,~}
    y = \frac{e^v}{e^u+e^v+e^w} \mbox{~and~}
    z = \frac{e^w}{e^u+e^v+e^w}
\end{equation}
...
\includegraphics[]{../figures/clrPCA.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
\includegraphics[]{../figures/majorPCA.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.6\textwidth}
...
\noindent\begin{minipage}[t][][b]{.35\textwidth}
\includegraphics[]{../figures/lrAFM.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.65\textwidth}
...
\includegraphics[]{../figures/LDAAFM.pdf}\medskip
\end{minipage}
