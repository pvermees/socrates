...
\noindent\begin{minipage}[t][][b]{.25\textwidth}
  \includegraphics[]{../figures/PCA2Ddata.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.27\textwidth}
  \includegraphics[]{../figures/PCA2D1.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.27\textwidth}
  \includegraphics[]{../figures/PCA2D2.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.73\textwidth}
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/PCA2D3.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.5\textwidth}
  \includegraphics[]{../figures/USArrests.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
  \includegraphics[]{../figures/eurodist.pdf}\medskip
\end{minipage}
...
\noindent\begin{minipage}[t][][b]{.3\textwidth}
  \includegraphics[]{../figures/Shepard.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.7\textwidth}
...
\begin{equation}
  d = 
  \bbordermatrix{  & 1 & 2 & 3 & 4 & \fbox{5} &
    6 & 7 & 8 & 9 & 10 & L & T & \fbox{Y} \cr
    ...
    \fbox{5} & 18 & 16 & 24 & 20 & 0 & 22 & 24 & 33 & 31 & 20 & 33 & 28 & \fbox{30} \cr
    ...
    \fbox{Y} & 40 & 43 & 8 & 16 & \fbox{30} & 49 & 52 & 62 & 16 & 13 & 11 & 7 & 0 
  }
  \label{eq:DZd}
\end{equation}
...
\noindent\begin{minipage}[t][][b]{.4\textwidth}
  \includegraphics[]{../figures/DZmds.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.6\textwidth}
...
\noindent\begin{minipage}[t][][b]{.25\textwidth}
  \includegraphics[]{../figures/kmeans1.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.75\textwidth}
...
\item Randomly select three data points from the dataset and designate
  ...
  \includegraphics[]{../figures/kmeans2.pdf}\medskip
  \end{minipage}
...
\item Reassign each data point to the cluster whose centroid is
  ...
  \noindent\begin{minipage}[t][][b]{.25\linewidth}
  \includegraphics[]{../figures/kmeans3.pdf}\medskip
  \end{minipage}
  \begin{minipage}[t][][t]{.75\linewidth}
...
\item Calculate a new centroid for each cluster:
  ...
  \noindent\begin{minipage}[t][][b]{.25\linewidth}
    \includegraphics[]{../figures/kmeans4.pdf}\medskip
  \end{minipage}
  \begin{minipage}[t][][t]{.75\linewidth}
...
\item Repeat steps~2 and 3 until convergence is achieved:
  ...
  \noindent\begin{minipage}[t][][b]{.25\linewidth}
  \includegraphics[]{../figures/kmeans5.pdf}\medskip
  \end{minipage}
  \begin{minipage}[t][][t]{.75\linewidth}
...
\noindent\begin{minipage}[t][][b]{.6\textwidth}
  \includegraphics[]{../figures/Iris.pdf}\medskip
\end{minipage}
...
\begin{minipage}[t][][b]{.25\textwidth}
  \includegraphics[]{../figures/hierarchical1.pdf}\medskip
\end{minipage}
\begin{minipage}[t][][t]{.5\textwidth}
...
\item\label{it:hierachical1} Put each data point in its own cluster
  ...
  \begin{equation*}
    d = \bbordermatrix{ & 1 & 2 & 3 & 4 & 5 \cr
      1 & 0 & 97.1 & \fbox{12.1} & 24.4 & 112 \cr
      2 & 97.1 & 0 & 90.4 & 76.0 & 38.6 \cr
      3 & \fbox{12.1} & 90.4 & 0 & 25.2 & 109 \cr
...
\item Identify the closest two clusters (corresponding to the boxed
  ...
  \includegraphics[]{../figures/hierarchical2.pdf}\medskip
  \end{minipage}
  \begin{minipage}[t][][b]{.3\linewidth}
    \includegraphics[]{../figures/tree1.pdf}\medskip
  \end{minipage}
...
\item\label{it:hierarchical2} Calculate the distances between the
  ...
  \begin{equation*}
    d = \bbordermatrix{ & 13 & 2 & 4 & 5 \cr
      13 & 0 & 97.1 & \fbox{25.2} & 112 \cr
      2 & 97.1 & 0 & 76.0 & 38.6 \cr
      4 & \fbox{25.2} & 76.0 & 0 & 87.7 \cr
      5 & 112 & 38.6 & 87.7 & 0
    }
  \end{equation*}
...
\item Identify the closest two clusters (corresponding to the boxed
  ...
  \begin{minipage}[t][][b]{.3\linewidth}
  \includegraphics[]{../figures/hierarchical3.pdf}\medskip
  \end{minipage}
  \begin{minipage}[t][][b]{.3\linewidth}
    \includegraphics[]{../figures/tree2.pdf}\medskip
  \end{minipage}
  \begin{minipage}[t][][b]{.4\linewidth}
...
\item Identify the two closest clusters (corresponding to the boxed
  ...
  \begin{minipage}[t][][b]{.3\linewidth}
  \includegraphics[]{../figures/hierarchical4.pdf}\medskip
  \end{minipage}
  \begin{minipage}[t][][b]{.3\linewidth}
    \includegraphics[]{../figures/tree3.pdf}\medskip
  \end{minipage}
  \begin{minipage}[t][][b]{.4\linewidth}
...
\item The final iteration yields the following tree:
  ...
  \begin{minipage}[t][][b]{.35\linewidth}
    \includegraphics[]{../figures/hierarchicaltree.pdf}
  \end{minipage}
...
\noindent\includegraphics[]{../figures/irishtree.pdf}
...
\noindent\includegraphics[]{../figures/irishtreecut.pdf}
